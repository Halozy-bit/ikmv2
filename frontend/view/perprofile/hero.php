        ...
        <div class="container">
            <div class="d-lg-flex flex-row  justify-content-around">
                <div class="d-flex col-lg-6 justify-content-center">
                    <img class="img-fluid" style="height:320px; border-radius:5%;" src="<?php echo $val['foto_owner']['f_wawancara'] ?>" alt="">
                </div>
            ...
            <div class="d-lg-flex flex-row-reverse justify-content-around">
                <div class="d-flex col-lg-6 justify-content-center">
                    <img class="img-fluid" style="height:320px; border-radius:5%;" src="<?php echo $val['foto_owner']['f_produksi'] ?>" alt="">
                </div>
